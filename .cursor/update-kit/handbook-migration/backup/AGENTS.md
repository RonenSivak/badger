...
|clickable-questions.md: How to present interactive options using AskQuestion tool
...
|optimization-principles.md: Core principles for simplifying TypeScript/React code
...
|generating-docs-patterns.md: Pattern extraction for adaptive documentation generation
