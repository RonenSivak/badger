...
# /deep-debug.resolve — Proof Loop 🛰️

Goal: produce:
- `.cursor/deep-debug/<topic>/mcp-s-notes.md`
- `.cursor/deep-debug/<topic>/octocode-queries.md`
- `.cursor/deep-debug/<topic>/trace-ledger.md`
