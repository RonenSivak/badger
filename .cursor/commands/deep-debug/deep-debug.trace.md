...
# /deep-debug.trace — Evidence Trace 🌐

Goal: produce `.cursor/deep-debug/<topic>/E2E-TRACE.md`
...
3) “Next resolution targets” list:
   - symbols/methods/services you must resolve cross-repo (feeds `/deep-debug.resolve`)
