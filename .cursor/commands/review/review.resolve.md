...
# /review.resolve — Proof Loop (UNLIMITED)
...
3) Record everything:
- `.cursor/review/<target>/mcp-s-notes.md`
- `.cursor/review/<target>/octocode-queries.md`

Maintain Trace Ledger (MANDATORY):
Write: `.cursor/review/<target>/trace-ledger.md`
