...
# /implement.load — Context Loader (deep-search → implementable spec)
...
- `.cursor/implement/<task>/`

## Outputs (write files)
1) `.cursor/implement/<task>/IMPLEMENTATION-SPEC.md`
Include:
- summary
- acceptance criteria
...
2) `.cursor/implement/<task>/SCOPE.md`
Include:
